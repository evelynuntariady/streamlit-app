#code infrencing biar ke ke streamlit
...
def main():
    ...
    sepal_length = st.number_input(label='Sepal Length', min_value=0.0, max_value=10.0, step=1.0)
    sepal_width = st.number_input(label='Sepal Width', min_value=0.0, max_value=10.0, step=1.0)
    patal_length = st.number_input(label='Patal Length', min_value=0.0, max_value=10.0, step=1.0)
    patal_width = st.number_input(label='Patal Width', min_value=0.0, max_value=10.0, step=1.0)
